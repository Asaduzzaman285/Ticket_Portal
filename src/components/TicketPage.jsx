                                ...
                                <tr key={ticket.id} className="align-middle">
                                    ...
                                    <td className="py-1 px-3 text-center">
                                        <span style={{
                                            ...
                                            borderRadius: '4px',
                                            fontSize: '11px',
                                            backgroundColor: ticket.status === 'closed' ? '#d4edda' : 
                                                           ticket.status === 'open' ? '#d1ecf1' : '#fff3cd',
                                            color: ticket.status === 'closed' ? '#155724' : 
                                                  ticket.status === 'open' ? '#0c5460' : '#856404',
                                            fontWeight: '600',
                                    ...
                                    <td className="py-1 px-3 text-center">{formatDateTime(ticket.purchase_time)}</td>
                                    <td className="py-1 px-3 text-center">
                                        <span style={{
                                            padding: '4px 12px',
                                            borderRadius: '4px',
                                            fontSize: '11px',
                                            backgroundColor: ticket.ticket_type === 'virtual' ? '#e3f2fd' : '#f3e5f5',
                                            color: ticket.ticket_type === 'virtual' ? '#1976d2' : '#7b1fa2',
                                            fontWeight: '600',
                                            textTransform: 'capitalize'
                                        }}>
                                    ...
                                    <td className="py-1 px-3 text-center">{ticket.customer_mobile || 'N/A'}</td>
                                    ...
                                    {/* <td className="py-1 px-3 text-center position-relative">
                                        <button
                                            ...
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                setActionMenuId(actionMenuId === ticket.id ? null : ticket.id);
                                            }}
                                        >
                                            ...
                                            >
                                                <button
                                                    onClick={() => {
                                                        ...
                                                        showAlert(`Viewing details for ticket ${ticket.ticket_no}`, 'info');
                                                    }}
                                                    className="dropdown-item py-0 px-2 d-flex align-items-center text-primary"
                                                    style={{ fontSize: "12px", height: "24px" }}
                                                >
                                                    <i className="fa-solid fa-eye me-2" style={{ fontSize: "12px" }}></i>
                                                    View Details
                                                </button>
                                            </div>
                                        )}
